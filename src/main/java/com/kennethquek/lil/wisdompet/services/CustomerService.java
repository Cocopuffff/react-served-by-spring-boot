...
import com.kennethquek.lil.wisdompet.data.repositories.CustomerRepository;
...
public class CustomerService {
    ...
    private Customer translateDbToWeb(CustomerEntity entity) {
        return new Customer(entity.getId(), entity.getFirstName(), entity.getLastName(), entity.getPhone(), entity.getEmail(), entity.getAddress());
    }
}
